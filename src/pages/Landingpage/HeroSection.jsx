  ...
  return (
    <div className="relative h-screen sm:h-[80vh] overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-white px-4 text-center">
        ...
        <button className="bg-purple-700 hover:bg-purple-800 text-white font-bold py-3 px-8 rounded-lg shadow-lg transition duration-300 uppercase text-sm tracking-widest">
          Reserve Now
        </button>
      </div>
    </div>
